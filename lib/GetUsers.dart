        ...
        return Expanded(
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                if (profiles[index].id == uid) return Center();
                return FlatButton(
                  onPressed: () {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => ChatSystem(
                          otherName: profiles[index]['name'],
                          otheruid: profiles[index].id,
                          myuid: uid,
                        ),
                      ),
                    );
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: ConstrainedBox(
                              ...
                              child: CircleAvatar(
                                radius: 45,
                                backgroundImage: (profiles[index]['url'] !=
                                            null &&
                                        profiles[index]['url']
                                            .toString()
                                            .isNotEmpty)
                                    ? NetworkImage(profiles[index]['url'])
                                    : NetworkImage(
